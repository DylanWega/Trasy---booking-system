    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchHotels.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // if the fields are not empty, continue as intended
                if (!location.equals("") || !checkIn.equals("") || !checkOut.equals("") || !numberOfAdults.equals("") || !numberOfRooms.equals("") || !numberOfChildren.equals("")) {
                ...
                // else show "fill all fields" message
                else {
